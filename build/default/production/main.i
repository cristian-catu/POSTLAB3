...
main:
    ...
    ;-------------- loop principal ---------------
LOOP:
    BTFSS ((PORTA) and 07Fh), 0 ; ((PORTA) and 07Fh), 0=0 llama a checkboton, ((PORTA) and 07Fh), 0=1 evalua otro bit
    CALL CHECKBOTON
    BTFSS ((PORTA) and 07Fh), 1 ; ((PORTA) and 07Fh), 1=0 llama a checkboton2, ((PORTA) and 07Fh), 1=1 evaluar otro bit
    CALL CHECKBOTON2

LOOP2:
    BTFSS ((INTCON) and 07Fh), 2 ; Verificamos interrupción del TMR0
    GOTO LOOP
    CALL RESET_TMR0
    MOVF contador, W
    XORWF PORTD, W
...
CHECKBOTON:
    BTFSS ((PORTA) and 07Fh), 0 ; ((PORTA) and 07Fh), 0=0 REGRESA, ((PORTA) and 07Fh), 0=1 INCREMENTA EL PORTB
    GOTO $-1
...
CHECKBOTON2:
    BTFSS ((PORTA) and 07Fh), 1 ; ((PORTA) and 07Fh), 1=0 REGRESA, ((PORTA) and 07Fh), 0=1 INCREMENTA EL PORTB
    GOTO $-1
